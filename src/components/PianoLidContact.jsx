  ...
  return (
    <div className="relative w-full overflow-hidden bg-bg text-ink transition-colors duration-300 dark:bg-[#0c0a14] dark:text-white">
      <div className="relative z-10 w-full px-6 pt-14 pb-10 sm:px-10 sm:pt-16 sm:pb-12 md:px-14 md:pt-20 md:pb-14 lg:px-16">
        ...
        <h2 className="select-none font-display text-6xl font-black uppercase leading-[0.9] tracking-tight text-ink dark:text-white sm:text-7xl md:text-8xl lg:text-[11rem] mb-10 sm:mb-12 md:mb-14">
          Connect With Me
        </h2>
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="flex flex-col items-start gap-5 sm:gap-6 lg:col-span-7">
            <p className="select-none font-display text-xs sm:text-sm md:text-base font-semibold uppercase tracking-[0.25em] text-primary dark:text-[#a29ed8]">
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-black/10 pt-6 font-display text-xs uppercase tracking-wide text-ink/70 dark:border-white/10 dark:text-white/70 sm:mt-14 sm:flex-row sm:items-center sm:justify-between sm:text-sm md:mt-16">
