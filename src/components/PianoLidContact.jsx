  ...
  return (
    ...
    >
      <div className="relative z-10 w-full px-6 pt-14 pb-10 sm:px-10 sm:pt-16 sm:pb-12 md:px-14 md:pt-20 md:pb-14 lg:px-16">
        ...
        <h2
          className="select-none font-display text-4xl font-black uppercase leading-[1 ] tracking-tight sm:text-3xl md:text-[clamp(5rem,2.33rem+4.56vw,9rem)] mb-10 sm:mb-12 md:mb-14 text-left md:text-center text-ink dark:text-white"
        >
