...
export default {
  ...
  fields: [
    ...
    {
      name: "portraitImageLight",
      title: "Portrait image — Light Theme",
      description: "The portrait photo shown in the intro grid in light mode. Falls back to a built-in default photo if left blank.",
      type: "image",
      options: { hotspot: true },
      group: "experienceNarrative",
    },
    {
      name: "portraitImageLightAlt",
      title: "Portrait image — Light Theme — alt text",
      type: "string",
      group: "experienceNarrative",
      placeholder: "Tony, seated outdoors in dark clothing beside a black horse",
      hidden: ({ document }) => !document?.portraitImageLight,
    },
    {
      name: "portraitImageDark",
      title: "Portrait image — Dark Theme",
      description: "The portrait photo shown in the intro grid in dark mode. Falls back to a built-in default photo if left blank.",
      type: "image",
      options: { hotspot: true },
      group: "experienceNarrative",
    },
    {
      name: "portraitImageDarkAlt",
      title: "Portrait image — Dark Theme — alt text",
      type: "string",
      group: "experienceNarrative",
      placeholder: "Tony, seated outdoors in dark clothing beside a black horse",
      hidden: ({ document }) => !document?.portraitImageDark,
    },
    {
      name: "portraitImage",
      title: "Portrait image (Legacy fallback)",
      description: "Legacy single portrait field. Prefer using Light and Dark theme fields above.",
      type: "image",
      options: { hotspot: true },
      group: "experienceNarrative",
      hidden: ({ document }) => Boolean(document?.portraitImageLight || document?.portraitImageDark),
    },
    {
    ...
    },
    {
      ...
      title: "Portrait image — alt text (Legacy)",
      type: "string",
      group: "experienceNarrative",
      placeholder: "Tony, seated outdoors in dark clothing beside a black horse",
      hidden: ({ document }) => Boolean(document?.portraitImageLight || document?.portraitImageDark || !document?.portraitImage),
    },
    {
